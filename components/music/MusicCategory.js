      ...
      >
        <View style={{ flexDirection: style.left_container.flexDirection }}>
          <Image
            ...
            style={{ width: style.left_container.width, height: style.left_container.height }}
          />
          <View style={{ flexDirection: style.mid_container.flexDirection }}>
            <Text style={{ fontWeight: style.mid_container.fontWeight, marginLeft: style.mid_container.marginLeft }}>
              {obj[item].name}
            </Text>
            <Text> {obj[item].artistName} </Text>
            <Text> {"#" + obj[item].tags.toString()} </Text>
          </View>
        </View>
        <View
          style={{
